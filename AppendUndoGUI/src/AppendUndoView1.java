...
public final class AppendUndoView1 extends JFrame implements AppendUndoView {
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        Stack<String> totalIn = new Stack1L<>();
        Stack<String> totalOut = new Stack1L<>();

        this.addStringToStack(totalIn, this.inputText.getText(), totalOut,
        ...
        if (source == this.resetButton) {
            ...
            this.controller.processUndoEvent(totalIn, totalOut);
        }
        /*
    ...
    private void addStringToStack(Stack<String> totalIn, String text,
            Stack<String> totalOut, String text2) {
