...
public abstract class ProgramTest {
    ...
    /**
     * The name of an original BL program.
     */
    private static final String FIRST = "data/FirstCode.bl";
    ...
    /**
     * Test replaceName on First.
     */
    @Test
    public final void testFirstReplaceName() {
        /*
         * Setup
         */
        Program pTest = this.createFromFileTest(FIRST);
        Program pRef = this.createFromFileRef(FIRST);
    ...
    /**
     * Test newContext on First.
     */
    @Test
    public final void testFirstNewContext() {
        /*
         * Setup
         */
        Program pTest = this.createFromFileTest(FIRST);
     ...
     */
    @Test
    public final void testFirstReplaceContext() {
        /*
         * Setup
         */
        Program pTest = this.createFromFileTest(FIRST);
    ...
    /**
     * Test newBody on First.
     */
    @Test
    public final void testFirstNewBody() {
        /*
         * Setup
         */
        Program pTest = this.createFromFileTest(FIRST);
    ...
    /**
     * Test replaceBody on First.
     */
    @Test
    public final void testFirstReplaceBody() {
        /*
         * Setup
         */
        Program pTest = this.createFromFileTest(FIRST);
