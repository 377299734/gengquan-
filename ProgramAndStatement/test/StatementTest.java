...
public abstract class StatementTest {
     ...
     * The name of a file containing a sequence of BL statements.
     */
    private static final String NESTED = "data/Nested.bl";
    ...
    /**
     * Test addToBlock in a nested loop
     */
    @Test
    public final void testNestedAddToBlockInterior() {
        /*
         * Setup
         */
        Statement sTest = this.createFromFileTest(NESTED);
        Statement sRef = this.createFromFileRef(NESTED);
        Statement emptyBlock = sRef.newInstance();
        Statement nestedTest = sTest.removeFromBlock(0);
        Statement nestedRef = sRef.removeFromBlock(0);
    ...
    /**
     * Test removeFromBlock in a nested loop leaving a non-empty block behind.
     */
    @Test
    public final void testNestedRemoveFromBlockFrontLeavingNonEmpty() {
        /*
         * Setup
         */
        Statement sTest = this.createFromFileTest(NESTED);
     ...
     */
    @Test
    public final void testDifferentLengthOfBlockNonEmpty() {
        /*
         * Setup
         */
        Statement sTest = this.createFromFileTest(NESTED);
     ...
     */
    @Test
    public final void testNestedDisassembleIfElse() {
        /*
         * Setup
         */
        final int ifElsePos = 1;
        Statement blockTest = this.createFromFileTest(NESTED);
        Statement blockRef = this.createFromFileRef(NESTED);
        Statement sTest = blockTest.removeFromBlock(ifElsePos);
        Statement sRef = blockRef.removeFromBlock(ifElsePos);
        Statement thenBlockTest = sTest.newInstance();
        Statement elseBlockTest = sTest.newInstance();
     ...
     */
    @Test
    public final void testNestedDisassembleWhile() {
        /*
         * Setup
         */
