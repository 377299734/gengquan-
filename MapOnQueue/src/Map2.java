...
public class Map2<K, V> extends MapSecondary<K, V> {
    ...
    public final void add(K key, V value) {
        ...
        Pair<K, V> add = new SimplePair<>(key, value);
        this.pairsQueue.enqueue(add);
    ...
    public final Pair<K, V> remove(K key) {
        ...
        Pair<K, V> removed = this.pairsQueue.dequeue();
    ...
    public final V value(K key) {
        ...
        moveToFront(this.pairsQueue, key);
        Pair<K, V> front = this.pairsQueue.front();
    ...
    public final boolean hasKey(K key) {
        ...
        for (int i = 0; i < this.pairsQueue.length(); i++) {
            if (this.pairsQueue.front().key().equals(key)) {
                contains = true;
            }
        }
