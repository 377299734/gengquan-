        ...
        switch (this.kind()) {
            case BLOCK: {
                ...
                for (int i = 0; i < this.lengthOfBlock(); i++) {
                    ...
                    m = this.removeFromBlock(i);

                    m.prettyPrint(out, offset);
            ...
            case IF: {
                ...
                Statement m = this.newInstance();
                Condition c = this.disassembleIf(m);

                printSpaces(out, offset);
                out.print("IF ");
                out.print(toStringCondition(c));
                out.println(" THEN");
            ...
            case WHILE: {
                ...
                Statement m = this.newInstance();
                Condition c = this.disassembleWhile(m);
